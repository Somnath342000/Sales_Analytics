...
# File Uploader
uploaded_file2 = st.file_uploader("Upload Sales Data CSV", type=["csv"], key="file2")
...
if uploaded_file2:
    try:
        ...
        ax.pie(region_sales, labels=region_sales.index, autopct='%1.1f%%', colors=["red", "lightblue", "yellow", "lightgreen"], startangle=90)
